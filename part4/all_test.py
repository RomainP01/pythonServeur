...
class MyTestCase(unittest.TestCase):
    ...
    def test_word_should_be_in_db(self):
        ...
        cur = con.cursor()
        query = "CREATE TABLE partie4 (word text)"
        con.execute(query)
    ...
    def test_get_a_dict_of_three_words(self):
        ...
        con.execute(query)
        con.commit()
        cur.execute("INSERT INTO partie4 VALUES('1')")
        con.commit()
        cur.execute("INSERT INTO partie4 VALUES('2')")
        con.commit()
        cur.execute("INSERT INTO partie4 VALUES('3')")
        con.commit()
